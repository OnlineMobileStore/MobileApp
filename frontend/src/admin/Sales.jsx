...
const Sales = () => {
  const summaryData = [
    { title: "Sales", value: 59467, icon: <FaShoppingCart />, growth: "3.4%", color: "#6C5DD3" },
    { title: "Returns", value: 28085, icon: <FaUndo />, growth: "2.5%", color: "#FF6D28" },
    { title: "Purchases", value: 39645, icon: <FaShoppingCart />, growth: "3.2%", color: "#2196F3" },
